...
const SHOW_FOLDER_INPUT = 'SHOW_FOLDER_INPUT';
...
const GET_BOOKMARKS_BY_FOLDER_SUCCESS = 'GET_BOOKMARKS_BY_FOLDER_SUCCESS'; // '/folder/bookmarks/:folderName'
const GET_BOOKMARKS_BY_FOLDER_ERROR = 'GET_BOOKMARKS_BY_FOLDER_ERROR';
const GET_BOOKMARKS_BY_TAG_SUCCESS = 'GET_BOOKMARKS_BY_TAG_SUCCESS'; // '/tag/bookmarks/:tagName'
